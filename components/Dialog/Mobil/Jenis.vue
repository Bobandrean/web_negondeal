                            ...
                            <v-row v-model="selected">
                                ...
                                <v-col md="8" class="scrollable">
                                    ...
                                    <v-row v-if="SelectedValue.nama == 'Plat Nomor'">
                                        <v-col v-for="list in plat_nomor" :value="list" :key="list"
                                            style="cursor: pointer" @click="handleSelectPlatNomor(list)" md="4"
                                            align="center">
                                            <v-row>
                                                <v-col>
                                                    <v-avatar size="80" rounded="0">
                                    ...
                                    <v-row v-if="SelectedValue.nama == 'Bahan Bakar'">
                                        <v-col v-for="list in bahanbakar" :value="list" :key="list"
                                            style="cursor: pointer" @click="handleSelectBahanBakar(list)" md="4"
                                            align="center">
                                            <v-row>
                                                <v-col>
                                                    <v-avatar size="80" rounded="0">
                                    ...
                                    <v-row v-if="SelectedValue.nama == 'Transmisi'">
                                        <v-col v-for="list in transmisi" :value="list" :key="list"
                                            style="cursor: pointer" @click="handleSelectTransmisi(list)" md="4"
                                            align="center">
                                            <v-row>
                                                <v-col>
                                                    <v-avatar size="80" rounded="0">
                                    ...
                                    <v-row v-if="SelectedValue.nama == 'Warna'">
                                        <v-col v-for="list in warna" :value="list" :key="list" style="cursor: pointer"
                                            @click="handleSelectWarna(list)" md="4" align="center">
                                            <v-row>
                                                <v-col>
                                                    <v-avatar size="80" rounded="0">
                                                        <v-img
                                    ...
                                    <v-row v-if="SelectedValue.nama == 'Jumlah Kursi'">
                                        <v-col v-for="list in tempat_duduk" :value="list" :key="list"
                                            style="cursor: pointer" @click="handleSelectTipe(list)" md="4"
                                            align="center">
                                            <v-row>
                                                <v-col md="12">
                                                    <v-avatar size="80" rounded="0">
...
export default {
    data: function () {
        return {
            ...
            bodi: ['Elektrik', 'Hatchback', 'Hybrid', 'MPV', 'Sedan', 'SUV', 'Wagon', 'Truck'],
            plat_nomor: ['Ganjil', 'Genap'],
            transmisi: ['AT', 'MT'],
            bahanbakar: ['Bensin', 'Diesel', 'Elektrik', 'Hybrid'],
            warna: ['Hitam', 'Putih', 'Silver', 'Abu Abu', 'Biru', 'Coklat', 'Merah', 'Hijau', 'Oranye', 'Lainnya'],
            tempat_duduk: ['2', '5', '7']
        }
    },
    setup(props, context) {
